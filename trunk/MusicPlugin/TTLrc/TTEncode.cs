...
namespace MusicSearch.TTLrc
{
    class TTEncode
    {
        ...
        /// <param name="lrcId">歌词ID</param>
        /// <returns></returns>
        public static string CreateQianQianCode(string Artist, string Title, int lrcId)
        {
            string qqHexStr = EncodeConverter.ToHexString(Artist + Title, Encoding.UTF8, false);
